...
<body>
	...
	*/
	...
	cookie.setMaxAge(30);//유지시간을 1시간으로 설정
	//응답헤더에 쿠키를 추가하여 클라이언트쪽으로 전송한다.
	...
	*/
	...
	<%
	/*
		request내장객체의 getCookies()를 통해 현재 생성된 모드 쿠키를
		배열의 형태로 가져온다.
	*/
	...
	if(cookies!=null){
		...
		String cookieName = c.getName();//이름 얻기 (JSESSIONID)
		String cookieValue = c.getValue();//값 얻기 (9167F8B7AFCB5488A2CE3B713E271539)
		//화면에 출력
		out.println(String.format("%s : %s<br/>", cookieName, cookieValue));
		/*
			쿠키가 생성된 직후에는 쿠키값을 읽을 수 없다.
			클라이언트측에 있는 쿠키를 서버로 다시 전송하기 위해 페이지 이동을 하거나 

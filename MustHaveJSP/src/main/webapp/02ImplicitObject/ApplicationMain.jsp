...
<body>
	...
	/*
		...
		더 넑은 지역인 선언부에서 사용하려면 매개변수로 전달받아야 한다.
	*/
		public String useImplicitObject(){
		/*
			방법1 : get ServletContext()메서드를 통해 선언부에서 
				application 얻어올 수 있다.
		*/
		return this.getServletContext().getRealPath("/02ImplicitObject");
		}
		/*
			방법2: 스크립트렛에서 메서드를 호출할 대 application 내장객체를
				매개변수로 전달해서 사용한다.
		*/
